...
class BasicConnectionPoolTest {
    ...
    static void setUp() {
        ...
        basicConnectionPool = new BasicConnectionPool(com.mysql.cj.jdbc.Driver.class.getName(),"jdbc:mysql://10.116.64.14:13306/nhn_academy_11","nhn_academy_11","T.T(RA8D7p2GLjz/",5);
    }
